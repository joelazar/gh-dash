...
// ViewKeyMap wraps the KeyMap for a specific view
...
func (v ViewKeyMap) ShortHelp() []key.Binding {
	return v.keyMap.ShortHelp()
}

func (v ViewKeyMap) FullHelp() [][]key.Binding {
	return v.keyMap.FullHelp(v.viewType)
}

// CreateKeyMapForView returns a help model for the specified view
func CreateKeyMapForView(viewType config.ViewType) ViewKeyMap {
	return ViewKeyMap{
		viewType: viewType,
		keyMap:   Keys,
	}
